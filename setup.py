    ...
    def run(self, *args, **kwargs):
        ...
        if is_apple_silicon and APPLE_UNIVERSAL:
            ...
            for arch in ("arm64", "x86_64"):
                ...
                subprocess.run(["make", "clean", "libdeflate.a"], cwd=libdeflate_dir, env={"CFLAGS": cflags})
            ...
            result = subprocess.run(["make", "clean", "libdeflate.a"], cwd=libdeflate_dir, env={"CFLAGS": "-fPIC"})
